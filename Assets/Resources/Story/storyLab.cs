...
public partial class @storyLab: Cradle.StoryFormats.Harlowe.HarloweStory
{
	#region Variables
	// ---------------
	...
	{
		yield return text("Сегодня я проснулся в отличном настроении.");
		yield return lineBreak();
		yield return text("Дженни вчера меня приятно удивила, да и на работе проект подходит к концу. ");
		yield return lineBreak();
	...
	IStoryThread passage3_Main()
	{
		...
		yield return lineBreak();
		yield return text("Добро пожаловать в исследовательский центр корпорации \"Пробиус\".");
		yield return lineBreak();
		yield return text("Двери в комнате надежно заперты и чтобы выбраться вам необходимо пройти игру.");
		yield return lineBreak();
	...
	{
		yield return text("Чтобы играть тебе будут необходимы монеты.");
		yield return lineBreak();
		yield return text("Заработать их ты можешь, потратив самое дорогое, что у тебя есть");
		yield return lineBreak();
	...
	{
		yield return text("Как только я закончил приводит себя в порядок вдруг заорала сирена.");
		yield return lineBreak();
		yield return text("Только не сегодня!");
		yield return lineBreak();
	...
	{
		yield return text("Прибежав в свой корпус, я сразу понял: \"Случилось что то неладное\"");
		yield return lineBreak();
		yield return text("Вокруг была бешанная суматоха, все носились как угарелые");
		yield return lineBreak();
	...
	{
		yield return text("Через некоторое время за стенами стали слышны крики и мольбы о помощи.");
		yield return lineBreak();
		yield return text("Но я не при чём, я словил дзен.");
		yield return lineBreak();
		yield return text("Дышать становится трудно, но мне и не надо дышать.");
		yield return lineBreak();
	...
	{
		yield return text("Я присел на бутылку и мне стало хорошо");
		yield return lineBreak();
		yield return lineBreak();
		yield return text("Если вам интересно, что будет дальше, скажите разработчику чтобы шёл нахуй");
		yield break;
	}
